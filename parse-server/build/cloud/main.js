...
Parse.Cloud.afterSave("LogauctiondepositplacedLogs", async (request) => {
...
Parse.Cloud.afterSave("LogauctiondepositretrievedLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
    //logger.info(
...
Parse.Cloud.afterSave("StateauctionclosedLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("StateauctionpendingauditLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("StateauctionpendingpaymentLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
    //logger.info(
...
Parse.Cloud.afterSave("StateauctionregisteredLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("StateauctionstartedbiddingLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
    //logger.info(
...
Parse.Cloud.afterSave("StateauctionverifyingwinnerLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
    //logger.info(
...
Parse.Cloud.afterSave("LognftmintedLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("LognftburnedLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("LognfttransferredLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("LogwinnerpaymentrefundedLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
...
Parse.Cloud.afterSave("LogsellerearningsretrievalLogs", async (request) => {
    const confirmed = request.object.get("confirmed");
    //const logger = Parse.Cloud.getLogger();
